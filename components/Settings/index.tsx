		...
		<>
			...
			<motion.div
				...
				className={cn(
					...
					"border border-t-0 border-white/20 bg-black/50 shadow-xl shadow-black/40 backdrop-blur-md"
				)}
			>
				<DraggableHandle
					dragControls={dragControls}
				...
				<div
					className={cn(
						"relative flex-col overflow-hidden px-4 pb-4 pt-5",
...
function DraggableHandle({
	...
	return (
		<motion.div
			...
			tabIndex={-1}
			className={cn(
				"absolute -top-[15px] z-50 flex h-7 w-[960px] items-center justify-center rounded-t-md",
				"touch-none select-none outline-none",
				"border border-white/20 border-b-0 bg-black"
				// "transition-all duration-100 ease-in-out",
...
function CustomThemeControls() {
	return (
		<motion.div
			...
			className={cn(
				"flex mt-4 justify-evenly gap-8 rounded-r-xl pb-4 pt-5",
